  ...
  return (
    <div className={cn('relative overflow-hidden', className)}>
      {showMask && (
        ...
        >
          <div className="w-full h-full bg-gradient-to-b from-slate-900 to-transparent z-10" />
        </div>
      )}
      ...
      {showMask && (
        ...
        >
          <div className="w-full h-full bg-gradient-to-t from-slate-900 to-transparent z-10" />
        </div>
      )}
    </div>
  )
