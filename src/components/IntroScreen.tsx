...
export const IntroScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4 safe-area-inset-top safe-area-inset-bottom">
      ...
      {/* Games Modal */}
      {showGames && (
        <Modal isOpen={showGames} onClose={() => setShowGames(false)} title="Games" maxWidth="2xl">
          <Games />
        </Modal>
      )}
      ...
      {/* Users Modal */}
      {showUsers && (
        <Modal isOpen={showUsers} onClose={() => setShowUsers(false)} title="Users" maxWidth="2xl">
          <Users />
        </Modal>
      )}
      ...
      {/* Decks Modal */}
      {showDecks && (
        <Modal isOpen={showDecks} onClose={() => setShowDecks(false)} title="Decks" maxWidth="2xl">
          <Decks />
        </Modal>
      )}
    </div>
